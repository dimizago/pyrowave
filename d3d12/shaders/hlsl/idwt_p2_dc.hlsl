...
// Profile portable; glslc defines: FP16=0 PRECISION=2; dxc defines: SPIRV_CROSS_CONSTANT_ID_0=true
...
cbuffer Registers
{
    int2 _154_resolution : packoffset(c0);
    float2 _154_inv_resolution : packoffset(c0.z);
};
...
float2 generate_mirror_uv(inout int2 coord, bool even_x, bool even_y)
{
    ...
    bool2 param_3 = bool2(coord.x >= _154_resolution.x, coord.y >= _154_resolution.y);
    coord += int2(band(param_2, param_3));
    float2 uv = float2(coord) * _154_inv_resolution;
    return uv.yx;
}
...
void load_image_with_apron()
{
    ...
    bool param_2 = true;
    bool param_3 = true;
    float2 _359 = generate_mirror_uv(param_1, param_2, param_3);
    float4 texels0 = float4(uTexture.GatherRed(_uTexture_sampler, float3(_359, 0.0f))).wxzy;
    int2 param_4 = coord0;
    bool param_5 = false;
    bool param_6 = true;
    float2 _379 = generate_mirror_uv(param_4, param_5, param_6);
    float4 texels1 = float4(uTexture.GatherRed(_uTexture_sampler, float3(_379, 2.0f))).wxzy;
    int2 param_7 = coord0;
    bool param_8 = true;
    bool param_9 = false;
    float2 _397 = generate_mirror_uv(param_7, param_8, param_9);
    float4 texels2 = float4(uTexture.GatherRed(_uTexture_sampler, float3(_397, 1.0f))).wxzy;
    int2 param_10 = coord0;
    bool param_11 = false;
    bool param_12 = false;
    float2 _415 = generate_mirror_uv(param_10, param_11, param_12);
    float4 texels3 = float4(uTexture.GatherRed(_uTexture_sampler, float3(_415, 3.0f))).wxzy;
    ...
    if (local_coord_horiz.y < 20)
    {
        ...
        bool param_19 = true;
        bool param_20 = true;
        float2 _463 = generate_mirror_uv(param_18, param_19, param_20);
        texels0 = float4(uTexture.GatherRed(_uTexture_sampler, float3(_463, 0.0f))).wxzy;
        int2 param_21 = base_coord + local_coord_horiz;
        bool param_22 = false;
        bool param_23 = true;
        float2 _481 = generate_mirror_uv(param_21, param_22, param_23);
        texels1 = float4(uTexture.GatherRed(_uTexture_sampler, float3(_481, 2.0f))).wxzy;
        int2 param_24 = base_coord + local_coord_horiz;
        bool param_25 = true;
        bool param_26 = false;
        float2 _499 = generate_mirror_uv(param_24, param_25, param_26);
        texels2 = float4(uTexture.GatherRed(_uTexture_sampler, float3(_499, 1.0f))).wxzy;
        int2 param_27 = base_coord + local_coord_horiz;
        bool param_28 = false;
        bool param_29 = false;
        float2 _517 = generate_mirror_uv(param_27, param_28, param_29);
        texels3 = float4(uTexture.GatherRed(_uTexture_sampler, float3(_517, 3.0f))).wxzy;
    ...
    if (local_coord_vert.x < 16)
    {
        ...
        bool param_36 = true;
        bool param_37 = true;
        float2 _554 = generate_mirror_uv(param_35, param_36, param_37);
        texels0 = float4(uTexture.GatherRed(_uTexture_sampler, float3(_554, 0.0f))).wxzy;
        int2 param_38 = base_coord + local_coord_vert;
        bool param_39 = false;
        bool param_40 = true;
        float2 _572 = generate_mirror_uv(param_38, param_39, param_40);
        texels1 = float4(uTexture.GatherRed(_uTexture_sampler, float3(_572, 2.0f))).wxzy;
        int2 param_41 = base_coord + local_coord_vert;
        bool param_42 = true;
        bool param_43 = false;
        float2 _590 = generate_mirror_uv(param_41, param_42, param_43);
        texels2 = float4(uTexture.GatherRed(_uTexture_sampler, float3(_590, 1.0f))).wxzy;
        int2 param_44 = base_coord + local_coord_vert;
        bool param_45 = false;
        bool param_46 = false;
        float2 _608 = generate_mirror_uv(param_44, param_45, param_46);
        texels3 = float4(uTexture.GatherRed(_uTexture_sampler, float3(_608, 3.0f))).wxzy;
